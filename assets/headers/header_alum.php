...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="menu_alumnos.php">Virtual Campus</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="perfil.php" class="getstarted">Buenas, <?php echo $_SESSION['nombre'] ?></a></li>
        </ul>
